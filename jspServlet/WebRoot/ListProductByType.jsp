...
<div class="collapse navbar-collapse js-navbar-collapse pull-right">
           <ul id="menu" class="nav navbar-nav" style="text-align: center;list-style: none">           
			    			    <li> <input type="submit" name="Home" value="HOME" class="titlelist"></li>
			 
			    <li> <input type="submit" name="ListMyAccount" value="MY ACCOUNT" class="titlelist"></li>

                <li> <input type="submit" name="ListShoppingCart" value="SHOPPING CART" class="titlelist"></li>

                <li> <input type="submit" name="ListProduct" value="PRODUCT" class="titlelist"></li>
    ...
    <div class="container">
      <div class="row ">
		...
		<!-- =====  BANNER STRAT  ===== --> 
			   <table><tr><td>
			<div style="color: #E74C3C;font-size: 25px"><b>${Product.prdclass}</b></div>
			<div>
	<c:forEach items = "${sessionScope.merchandiselisttype}" var ="Product">
