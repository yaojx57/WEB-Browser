    ...
    <div class="container">
      <div class="row ">
		...
		<!-- =====  BANNER STRAT  ===== --> 
			...
			<br>username : <input type="text" name="cs_id"/>
			<br>password : <input type="text" name="password"/>
			<br><input type="SUBMIT" name="submit" value="Submit" style="border:none;background: #E74C3C;color: #FFFFFF;font-size: 18px"> </br>
			<br><a href="Register.jsp">Click here to sign up for a new account.</a>
				</td></tr>
			<!-- =====  BANNER END  ===== -->
