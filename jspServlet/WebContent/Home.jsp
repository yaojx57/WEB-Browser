        ...
        <div class="container">
          <nav class="navbar">
            <div class="navbar-header mtb_20"> <img alt="DOG" src="images/logo.png" width="200"> </div>
			  <div class="navbar-collapse js-navbar-collapse pull-right collapse in" aria-expanded="true">
        ...
        <div id="column-right" class="col-sm-8 col-md-8 col-lg-9 mtb_30">
	     <div class="banner">
	            <div class="main-banner owl-carousel">
	              <div class="item"><a href="#"><img src="images/product/product9.jpg" alt="Main Banner" class="img-responsive" /></a></div>
	              <div class="item"><a href="#"><img src="images/product/product9.jpg" alt="Main Banner" class="img-responsive" /></a></div>
	            </div>
	      </div>
		  <div>
