...
<% String cs_id =(String) session.getAttribute("cs_id");%>
    <% String cs_name = (String)session.getAttribute("cs_name"); %>
    <%String cs_gender = (String)session.getAttribute("cs_gender"); %>
    <%String cs_address = (String)session.getAttribute("cs_address"); %>
    <%String cs_phonenumber= (String)session.getAttribute("cs_phonenumber"); %>
    ...
    <div class="container">
      <div class="row ">
        ...
        <div id="column-right" class="col-sm-8 col-md-8 col-lg-9 mtb_30">
          <table>
		    <tr><td>
			  <div style="color: #E74C3C"><b>MY ACCOUNT</b></div>
				<div>
				  <ul>
					<li>name :<%= cs_name %></li>
					<li>id :<%= cs_id %></li>
					<li>gender:<%= cs_gender %></li>
					<li>phone number:<%= cs_phonenumber %></li>
					<li>address:<%= cs_address %></li>
				   </ul>
				 </div>	 
			 	 <div>
					  <form action="./LogOut" method="post">
					  	<input type="submit" name="LogOut" value="Log out" style="background: #E74C3C;border: none;font-size: 18px;color:#FFFFFF">
					  </form>
				  </div>
			</td></tr>
			<tr><td>
