          ...
          <nav class="navbar">
            <div class="navbar-header mtb_20"> <img alt="DOG" src="images/logo.png" width="200"> </div>
				<div class="collapse navbar-collapse js-navbar-collapse pull-right">
			      ...
			      <li> <form action="./Home"  method="post" ><input type="submit" value="HOME" class="titlelist"></form></li>
    ...
    <div class="container">
      <div class="row ">
        ...
        <table>
		 <tr><td>
			<div>
	<img alt="DOG" src="images/logo.png" width="615px">
		<p>
			Since its inception, our company has been committed to the application of robots in various fields, including daily life, industrial manufacturing, construction and so on.
			You can learn about our business philosophy and details of our products through this web page. If you are a personal user, you can also purchase goods through this page.
			If you are the representative of the company and have the intention to cooperate with us, please call our company by telephone or send an email. We will reply as soon as we see it.
		</p>
	</div>		  
				</td></tr>
				  <tr><td>
