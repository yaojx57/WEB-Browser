		          ...
		          <div class="product-grid">
                   <div class="item">
		            <div class="product-thumb">
		              <div class="image product-imageblock"><a href="#"><img data-name="product_image" alt="iPod Classic" src="${Product.prdimages}"title="iPod Classic" class="img-responsive"><img src="${Product.prdimages}" alt="iPod Classic" title="iPod Classic" class="img-responsive"></a></div>
		              <div class="caption product-detail text-left">
		                <h6 data-name="product_name" class="product-name mt_20"><a href="#" title="Casual Shirt With Ruffle Hem">${Product.prdname}</a></h6>
		                <div class="rating"> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i><i class="fa fa-star fa-stack-1x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i><i class="fa fa-star fa-stack-1x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i><i class="fa fa-star fa-stack-1x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i><i class="fa fa-star fa-stack-1x"></i></span> <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i><i class="fa fa-star fa-stack-x"></i></span> </div>
		                <span class="price"><span class="amount"><span class="currencySymbol">$</span>${Product.prdprice}</span></span>
		              <div class="caption product-detail text-right">
		              <span><input type="image" name="addtocart" src="images/cart.jpg" value="add to cart" width="50" alt="submit"></span></div>
		                <div class="button-group text-center">
		                  <% String cs_id =(String)session.getAttribute("cs_id"); %>
							<form action="./AddShoppingCart" method="post">
		                    	<input type="hidden" name="cs_id" value="<%=cs_id %>">
		                    	<input type="hidden" name="me_name" value="${Product.prdname}">
		                    	<input type="hidden" name="me_price" value="${Product.prdprice}">
		                    </form>
		                </div>
		              </div>
		       	     </div>
...
<!-- 	            <div class="col-md-5"> -->
<!-- 	              <div class="caption product-detail text-left"> -->
<%-- 					<input type="image" src="${Product.prdimages}" class="img-responsive" alt="submit" width="300" height="100"> --%>
<!-- 				   </div> -->
<!-- 	               <div class="caption product-detail text-left"> -->
<!--                        <h6 data-name="product_name" class="product-name mt_20">Hachi Guide Dog</h6> -->
...
<%--                          	<input type="hidden" name="me_name" value="${Product.prdname}"> --%>
<%--                          	<input type="hidden" name="me_price" value="${Product.prdprice}"> --%>
<!--                          	<input type="image" name="addtocart" src="images/cart.jpg" value="add to cart" width="50" alt="submit"> -->
<!--                         </form></div> -->
<!--                        </div> -->
<!--                      </div> -->
<!--                    </div> -->
