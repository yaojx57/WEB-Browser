          ...
          <nav class="navbar">
            <div class="navbar-header mtb_20"> <img alt="DOG" src="images/logo.png" width="200"> </div>
			 <div class="collapse navbar-collapse js-navbar-collapse pull-right">
                ...
                <li><a herf="About.jsp" class="titlelist" style="display: table-cell;vertical-align: middle;text-align: center">ABOUT US</a></li>
          	 </ul>
            </div>
            <!-- /.nav-collapse -->
          </nav>
        ...
        <div id="column-right" class="col-sm-8 col-md-8 col-lg-9 mtb_30">
         <form action="./Register" method="post">
          <div class="form-group">
           ...
           <input type="text" class="form-control" name="cs_id" id="id" placeholder="Enter ID">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
           ...
           <input type="text" class="form-control" name="cs_name" id="name" placeholder="Enter Your Name">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
           ...
           <input type="text" class="form-control" name="cs_phonenumber" id="phone_number" placeholder="Enter Phone Number">
          </div>
          <div class="form-group">
           <label for="address">Address</label>
           <input type="text" class="form-control" name="cs_address" id="address" placeholder="Enter Address">
          </div>
          <button type="submit" class="btn btn-primary" name="submit" value="submit">Submit</button>
         </form>
<!-- 	<div> -->
<!-- 	<h2 align="center">customer register</h2> -->
	
<!-- <form action="./Register" method="post"> -->
<!-- <table style="border: 1px;margin: 0 auto;" width="50%" cellpadding="5" cellspacing="0" > -->

<!-- 	<tr> -->
<!-- 		<td style="background:#FFFFFF;color:#E74C3C"><b>ID</b></td> -->

<!--         <td><input type="text" name="cs_id"style="width:95%"></td> -->
        
<!--         <td style="background: #FFFFFF;color:#E74C3C"><b>password</b></td> -->

<!--         <td><input type="password" name="password"style="width:95%"></td> -->
<!-- 	</tr> -->
<!--     <tr> -->

<!--         <td style="background:#FFFFFF ;color:#E74C3C"><b>name</b></td> -->

<!--         <td><input type="text" name="cs_name"style="width:95%"></td> -->

<!--         <td style="background:#FFFFFF;color: #E74C3C"><b>gender</b></td> -->

<!--         <td><input type="radio" name="cs_gender" value="female">Female<input type="radio" name="cs_gender" value="male">Male<br></td> -->

<!--     </tr> -->
<!--     <tr> -->

<!--         <td style="background:#FFFFFF ;color:#E74C3C"><b>phone number</b></td> -->

<!--         <td><input type="text" name="cs_phonenumber"style="width:95%"></td> -->
<!--         <td style="background: #FFFFFF;color:#E74C3C"><b>address</b></td> -->

<!--         <td><input style="width: 95%; " type="text" name="cs_address"></td> -->
 
<!--     </tr> -->
<!-- 					</table> -->
<!-- 					<p></p> -->
<!-- 	<div style="text-align:center"><input type="SUBMIT" name="submit" value="Submit" style="background:#E74C3C;color:#FFFFFF;font-size:22px;border:none;margin: auto"></div> -->
